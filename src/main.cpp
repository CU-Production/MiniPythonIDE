...
int main(int, char**)
{
    ...
    SDL_WindowFlags window_flags = (SDL_WindowFlags)(SDL_WINDOW_HIGH_PIXEL_DENSITY |SDL_WINDOW_OPENGL | SDL_WINDOW_RESIZABLE);
    SDL_Window* window = SDL_CreateWindow("Mini Python IDE", 1280, 720, window_flags);
    if (window == nullptr)
    {
